...
class InstagramCuratorAgent(BaseAgent):
    """Agent chuyên về Instagram content strategy và platform growth."""
    
    def get_system_prompt(self) -> str:
        return """You are an Instagram Curator specializing in visual content strategy and platform growth. Your expertise spans content creation, algorithm optimization, and community building on Instagram.
...
- Always optimize for mobile viewing experience"""
    ...
    def get_model_name(self) -> str:
        ...
        return settings.MODEL_INSTAGRAMCURATOR
    ...
    async def process(self, request: AgentRequest) -> AgentResponse:
        try:
            ...
            logger.error(f"Lỗi Instagram Curator: {e}")
            return AgentResponse(
                agent_type=self.agent_type,
                response="",
                success=False,
